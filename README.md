...
2. Select all the text and copy it (`Ctrl+A` then `Ctrl+C` on Windows, `Cmd+A` then `Cmd+C` on Mac)
3. Go to [claude.ai](https://claude.ai) and open **Settings**
4. Find **"Custom Instructions"** or **"Memory & Skills"** and paste the text in

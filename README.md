...
**Skills fix that.** A skill is a plain text file you upload to your AI that gives it specific knowledge for one part of your business. Think of it like handing your AI a one-page training doc before asking it a question. Once it has the skill loaded, it gives you answers that actually make sense for your industry instead of generic advice.
...
5. Add the skill for future use!

That's it. Now when you ask Claude about that topic, it already knows how your industry works.

To see it in action, try prompting Claude with this
> Hey Claude — I just added the “yard-quote-estimator” skill. Can you help me quote a customer?

> **Tip:** Most solo owners keep 3–4 skills loaded at all times. A good starting set is the quoting skill, the complaint response skill, and the price increase skill — those three cover the situations where saying the wrong thing costs you the most.

---

## What these skills are (and aren't)

These skills are for situations where you need the **right words, the right judgment, or the right framework** — and you're the one making the decision.

They are not software integrations. They don't connect to your route software, your customer list, or Google Maps. They work entirely through conversation — you describe the situation, the AI applies the skill, and you get a useful answer.
...
| Sponsor | Skill |
|---------|-------|
| Zachary Glontz | [yard-quote-estimator](#-pricing--money) |
...
✅ Complete — click Download to use it now. &nbsp; ○ Not yet written — [email us](mailto:info@maptheday.com) to contribute.
